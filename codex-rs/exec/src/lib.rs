...
fn should_suppress_autonomous_for_error(info: Option<&CodexErrorInfo>) -> bool {
    matches!(
        info,
        Some(CodexErrorInfo::UsageLimitExceeded | CodexErrorInfo::ServerOverloaded)
        ...
        match server_event {
            ...
            InProcessServerEvent::LegacyNotification(notification) => {
                ...
                if let EventMsg::Error(payload) = &event.msg {
                    ...
                    error_seen = true;
                    if should_suppress_autonomous_for_error(payload.codex_error_info.as_ref()) {
                        suppress_autonomous_for_current_turn = true;
                    }
                }
                match &event.msg {
